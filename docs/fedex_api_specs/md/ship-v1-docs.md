...
-   [Ship API](https://developer.fedex.com/api/en-ms/catalog/ship.html) 
...
For more information, see [Minimum customs value countries](https://developer.fedex.com/api/en-ms/guides/api-reference.html#minimumcustomsvaluecountriesorterritories)
...
_Note: The Other documents are only uploaded based on countries, products and other special custom document. To view a list of many other commonly used documents click [Export Documents](https://developer.fedex.com/api/en-ms/guides/api-reference.html#exportdocuments)_
...
For more information on the service areas for Domestic shipping, see [Europe Domestic Services Portfolio.](https://developer.fedex.com/api/en-ms/guides/api-reference.html#europenewdomesticservicesportfolio)
...
-   Montserrat-   English
    ...
    -   [English](https://developer.fedex.com/api/en-ms/catalog/ship/docs.html)