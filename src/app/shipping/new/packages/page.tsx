  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">送り状作成 (3/5)</h1>
          <p className="text-gray-600">荷物の詳細を入力してください</p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-[#4D148C] h-2 rounded-full" style={{ width: "60%" }}></div>
          </div>
        </div>
